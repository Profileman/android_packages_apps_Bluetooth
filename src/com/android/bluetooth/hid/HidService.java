    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                {
                    BluetoothDevice device = (BluetoothDevice) msg.obj;
                    if(true){ //!getIdleTimeNative(Utils.getByteAddress(device)) ) {
                        Log.e(TAG, "Error: get idle time native returns false (pipo hack)");
                    }
                }
                break;
                ...
                case MESSAGE_SET_IDLE_TIME:
                {
                    ...
                    if(true){ //!setIdleTimeNative(Utils.getByteAddress(device), idleTime)) {
                        Log.e(TAG, "Error: get idle time native returns false (pipo hack)");
                    }
                }
                break;
                case MESSAGE_SET_PRIORITY:
                {
                    ...
                    if (true){ //!setPriorityNative(Utils.getByteAddress(device), priority)) {
                        Log.e(TAG, "Error: set priority native returns false (pipo hack)");
                    }
                }
                break;
            }
